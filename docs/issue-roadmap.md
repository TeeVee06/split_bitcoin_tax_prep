...
6. `Parser support: Strike CSV`
   Official docs: Strike transaction history export
   Acceptance criteria: recognize Strike CSV, normalize BTC buy/send/receive rows, reject unsupported layouts.

7. `Parser support: River CSV`
...
8. `Parser support: Fold Bitcoin CSV`
